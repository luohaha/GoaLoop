...
Drop generated images here. The README references these exact filenames,
so name your exports to match (or update the README links if you rename).

| Filename | What it is | Prompt (see [`../image-prompts.md`](../image-prompts.md)) |
|---|---|---|
...
- Prefer transparent-background PNGs for the logo so it works in light and
  dark README rendering.
- Keep the header logo reasonably small (the README sizes it to ~160px).
- Regenerate from the prompts in `../image-prompts.md`; tweak the hex
  palette there to restyle the whole set at once.
